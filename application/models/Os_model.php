...
class Os_model extends CI_Model
{
    ...
    public function getQrCode($id, $pixKey, $emitente)
    {
        ...
        $pix = (new StaticPayload())
            ->setAmount($amount)
            ->setTid($id)
            ->setDescription(sprintf('%s OS %s', substr($emitente->nome, 0, 18), $id))
    ...
    {
        $this->db->select('equipamentos_os.*, equipamentos.equipamento, equipamentos.num_serie, equipamentos.modelo, marcas.marca');
