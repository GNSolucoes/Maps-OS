...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <?php
        $img_login = base_url('assets/img/dashboard-animate.svg');
        if (isset($configuration->imagem_login) && !empty($configuration->imagem_login)) {
            $img_login = base_url('uploads/site/' . $configuration->imagem_login);
        }
      ?>
      <img src="<?= $img_login ?>" class="left-login-image" alt="Map-OS - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
            ...
            <div class="card">
              <div class="content">
                <div id="newlog">
                  <div class="icon2">
                    <?php
                        $logo = base_url('assets/img/logo-two.png');
                        if (isset($configuration->logo) && !empty($configuration->logo)) {
                            $logo = base_url('uploads/site/' . $configuration->logo);
                        }
                    ?>
                    <img src="<?= $logo ?>">
                  </div>
