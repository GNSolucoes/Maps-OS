            ...
            <form action="<?php echo current_url(); ?>" id="formConfigurar" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    ...
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="control-group">
                            <label for="tawk_to_embed" class="control-label">Tawk.to Embed Code (Chat)</label>
                            <div class="controls">
                                <textarea rows="5" name="tawk_to_embed" class="span12"><?= isset($configuration['tawk_to_embed']) ? $configuration['tawk_to_embed'] : '' ?></textarea>
                                <span class="help-inline">Cole aqui o código de widget do Tawk.to para chat ao vivo. Aparecerá no Site e Área do Cliente.</span>
                            </div>
                        </div>
