    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <h5>Novo Template de Checklist</h5>
            </div>
            <?php if ($custom_error != '') {
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="btn btn-default" style="margin-bottom: 0">
                                    <input type="checkbox" id="ativo" name="ativo" value="1" <?php echo set_checkbox('ativo', '1', true); ?>> Ativo
                                </label>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    // Adicionar pelo menos um item inicial
    addChecklistItem();
});
</script>
