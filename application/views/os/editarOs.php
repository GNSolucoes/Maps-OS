                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span4">
                                            ...
                                            <select class="span12" name="usuarios_id" id="usuarios_id">
                                                ...
                                                <?php foreach($usuarios as $u) { 
                                                    $selected = ($u->idUsuarios == $result->usuarios_id) ? 'selected' : '';
                                        ...
                                        <div class="span4">
                                            ...
                                            <select class="span12" name="tipo" id="tipo">
                                                <option <?php if ($result->tipo == 'Externo') { echo 'selected'; } ?> value="Externo">Externo</option>
                                                <option <?php if ($result->tipo == 'Interno') { echo 'selected'; } ?> value="Interno">Interno</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span12">
                                            <label for="equipamento_descricao">Equipamento (Preencher via busca para adicionar à descrição)</label>
                                            <div class="input-prepend span12" style="display: flex;">
                                                <span class="add-on"><i class="bx bx-devices"></i></span>
                                                <input id="equipamento_descricao" class="span12" type="text" name="equipamento_descricao" placeholder="Digite o nome ou modelo do equipamento do cliente..." />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <form id="formEquipamentos" action="<?php echo base_url() ?>index.php/os/adicionarEquipamento" method="post">
                                    <div class="span6">
                                        ...
                                        <input type="text" class="span12" name="equipamento" id="equipamento" placeholder="Digite para buscar equipamento" />
                                    </div>
                                    <div class="span2">
                                        <label for="">&nbsp;</label>
                                        <button class="button btn btn-success" id="btnAdicionarEquipamento">
                                            <span class="button__icon"><i class='bx bx-plus-circle'></i></span> <span class="button__text2">Adicionar</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
                            <div class="widget-box" id="divEquipamentos">
                                <div class="widget_content nopadding">
                                    <table width="100%" class="table table-bordered" id="tblEquipamentos">
                                        <thead>
                                            <tr>
                                                <th>Equipamento</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($equipamentos as $e) {
                                                ...
                                                echo (strtolower($result->status) != "cancelado") ? '<td><div align="center"><a href="" idAcao="' . $e->idEquipamentos_os . '" title="Excluir Equipamento" class="btn-nwe4 equipamento"><i class="bx bx-trash-alt"></i></a></div></td>' : '<td></td>';
                                                echo '</tr>';
                                            }
                                            if (!$equipamentos) {
                                                echo '<tr><td colspan="5">Nenhum equipamento vinculado</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#equipamento").autocomplete({
            source: function(request, response) {
                $.ajax({
                    ...
                    data: {
                        term: request.term,
                        cliente_id: <?php echo $result->clientes_id; ?>
                    },
                    success: function(data) {
                        response(data);
                    }
            ...
            select: function(event, ui) {
                ...
                $("#equipamento").val(ui.item.equipamento);
                return false;
            }
        });

        // Equipment autocomplete for description
        $("#equipamento_descricao").autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/os/autoCompleteEquipamento",
                    dataType: "json",
        ...
        $("#formEquipamentos").submit(function(event) {
            event.preventDefault();
        ...
        $(document).on('click', '.equipamento', function(event) {
            ...
            Swal.fire({
                title: 'Tem certeza?',
                text: "Deseja realmente excluir este equipamento da OS?",
                icon: 'warning',
