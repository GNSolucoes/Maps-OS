...
<body>
    <div class="main-login">
        <div class="left-login">
            ...
            <?php
            $img_cliente = base_url('assets/img/forms-animate.svg');
            if (isset($configuration->imagem_cliente) && !empty($configuration->imagem_cliente)) {
                $img_cliente = base_url('uploads/site/' . $configuration->imagem_cliente);
            }
            ?>
            <img src="<?= $img_cliente ?>" class="left-login-imagec" alt="Map-OS 5.0">
        </div>
