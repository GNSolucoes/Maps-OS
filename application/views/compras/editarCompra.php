                    ...
                    <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="status" class="span12">
                                        <option value="orcamento" <?php echo ($result->status == 'orcamento') ? 'selected' : ''; ?>>Orçamento</option>
                                        <option value="aprovado" <?php echo ($result->status == 'aprovado') ? 'selected' : ''; ?>>Aprovado</option>
                                        <option value="pedido" <?php echo ($result->status == 'pedido') ? 'selected' : ''; ?>>Pedido</option>
                                        <option value="recebido" <?php echo ($result->status == 'recebido') ? 'selected' : ''; ?>>Recebido</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <?php 
                                ...
                                if(isset($pagamentos) && !empty($pagamentos)){
                                     $pagamento_status = $pagamentos[0]->status;
                                     $pagamento_forma = $pagamentos[0]->forma_pagamento;
                                }
                            ?>
                            <div class="control-group">
                                <label class="control-label">Situação Pagamento</label>
                                <div class="controls">
                                    <select name="situacao_pagamento" class="span12" <?php echo ($result->status == 'recebido') ? 'disabled' : ''; ?>>
                                        <option value="pendente" <?php echo ($pagamento_status == 'pendente') ? 'selected' : ''; ?>>A Pagar (Pendente)</option>
                                        <option value="pago" <?php echo ($pagamento_status == 'pago') ? 'selected' : ''; ?>>Pago</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="forma_pagamento" class="span12" <?php echo ($result->status == 'recebido') ? 'disabled' : ''; ?>>
                                        <option value="Dinheiro" <?php echo ($pagamento_forma == 'Dinheiro') ? 'selected' : ''; ?>>Dinheiro</option>
                                        <option value="Pix" <?php echo ($pagamento_forma == 'Pix') ? 'selected' : ''; ?>>Pix</option>
                                        <option value="Boleto" <?php echo ($pagamento_forma == 'Boleto') ? 'selected' : ''; ?>>Boleto</option>
                                        <option value="Cartão Crédito" <?php echo ($pagamento_forma == 'Cartão Crédito') ? 'selected' : ''; ?>>Cartão Crédito</option>
                                        <option value="Cartão Débito" <?php echo ($pagamento_forma == 'Cartão Débito') ? 'selected' : ''; ?>>Cartão Débito</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="number" step="0.01" name="desconto" value="<?php echo $result->desconto; ?>" id="desconto" />
                                </div>
                            </div>
                        <div class="control-group">
