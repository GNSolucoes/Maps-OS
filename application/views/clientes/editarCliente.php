                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                         ...
                         <div class="control-group">
                            <label for="parceiros_id" class="control-label">Indicado por (Parceiro)</label>
                            <div class="controls">
                                <select id="parceiros_id" name="parceiros_id">
                                    <option value="">Selecione...</option>
                                    <?php foreach ($parceiros as $parceiro) {
                                        $selected = ($parceiro->idParceiros == $result->parceiros_id) ? 'selected' : '';
                                        echo '<option value="' . $parceiro->idParceiros . '" ' . $selected . '>' . $parceiro->nome . '</option>';
                                    } ?>
                                </select>
                            </div>
                        </div>
