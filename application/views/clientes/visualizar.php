                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($result->telefone) { ?>
                                            <a href="<?= whatsapp_link($result->telefone, 'Olá ' . $result->nomeCliente) ?>" target="_blank" class="btn btn-mini btn-success tip-top" title="WhatsApp"><i class="bx bxl-whatsapp"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($result->celular) { ?>
                                            <a href="<?= whatsapp_link($result->celular, 'Olá ' . $result->nomeCliente) ?>" target="_blank" class="btn btn-mini btn-success tip-top" title="WhatsApp"><i class="bx bxl-whatsapp"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <tr>
