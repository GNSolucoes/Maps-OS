                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-block">Tamanho máx: 2MB | Formatos: JPG, PNG</span>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="modelo" type="text" name="modelo" value="<?php echo set_value('modelo'); ?>" placeholder="Ex: Galaxy S20, iPhone 13" />
                        </div>
                    </div>
                    <div class="control-group">
