    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <form action="<?php echo current_url(); ?>" id="formMarca" method="post" class="form-horizontal">
                <input type="hidden" name="idMarcas" value="<?php echo $result->idMarcas; ?>" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="btn btn-default" style="margin-bottom: 0">
                                    <input type="checkbox" id="situacao" name="situacao" value="1" <?php echo ($result->situacao == 1) ? 'checked' : ''; ?>> Ativa
                                </label>
                            </div>
                        </div>
                    </div>
