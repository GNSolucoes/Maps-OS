...
class Login extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['configuration'] = $this->site_model->getConfig();
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                if (password_verify($password, $user->senha)) {
                    ...
                    if ($permissao && $permissao->nome == 'Técnico') {
                         $json = ['result' => false, 'message' => 'Atenção: Técnicos devem utilizar o Painel do Técnico para acessar o sistema.'];
                         echo json_encode($json);
                         exit();
                    }
